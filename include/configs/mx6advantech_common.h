 ...
 *
 * Configuration settings for Advantech boards.
 */

#ifndef __MX6QADVANTECH_COMMON_CONFIG_H
#define __MX6QADVANTECH_COMMON_CONFIG_H
...
#endif /* __MX6QADVANTECH_COMMON_CONFIG_H */
