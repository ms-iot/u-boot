...
static iomux_v3_cfg_t const backlight_pads[] = {
	...
	MX6Q_PAD_SD1_CMD__GPIO1_IO18 | MUX_PAD_CTRL(NO_PAD_CTRL),
};

static iomux_v3_cfg_t const rgb_pads[] = {
	MX6Q_PAD_DI0_DISP_CLK__IPU1_DI0_DISP_CLK,
	MX6Q_PAD_DI0_PIN15__IPU1_DI0_PIN15,
	MX6Q_PAD_DI0_PIN2__IPU1_DI0_PIN02,
	MX6Q_PAD_DI0_PIN3__IPU1_DI0_PIN03,
	MX6Q_PAD_DI0_PIN4__GPIO4_IO20,
	MX6Q_PAD_DISP0_DAT0__IPU1_DISP0_DATA00,
	MX6Q_PAD_DISP0_DAT1__IPU1_DISP0_DATA01,
	MX6Q_PAD_DISP0_DAT2__IPU1_DISP0_DATA02,
	MX6Q_PAD_DISP0_DAT3__IPU1_DISP0_DATA03,
	MX6Q_PAD_DISP0_DAT4__IPU1_DISP0_DATA04,
	MX6Q_PAD_DISP0_DAT5__IPU1_DISP0_DATA05,
	MX6Q_PAD_DISP0_DAT6__IPU1_DISP0_DATA06,
	MX6Q_PAD_DISP0_DAT7__IPU1_DISP0_DATA07,
	MX6Q_PAD_DISP0_DAT8__IPU1_DISP0_DATA08,
	MX6Q_PAD_DISP0_DAT9__IPU1_DISP0_DATA09,
	MX6Q_PAD_DISP0_DAT10__IPU1_DISP0_DATA10,
	MX6Q_PAD_DISP0_DAT11__IPU1_DISP0_DATA11,
	MX6Q_PAD_DISP0_DAT12__IPU1_DISP0_DATA12,
	MX6Q_PAD_DISP0_DAT13__IPU1_DISP0_DATA13,
	MX6Q_PAD_DISP0_DAT14__IPU1_DISP0_DATA14,
	MX6Q_PAD_DISP0_DAT15__IPU1_DISP0_DATA15,
	MX6Q_PAD_DISP0_DAT16__IPU1_DISP0_DATA16,
	MX6Q_PAD_DISP0_DAT17__IPU1_DISP0_DATA17,
	MX6Q_PAD_DISP0_DAT18__IPU1_DISP0_DATA18,
	MX6Q_PAD_DISP0_DAT19__IPU1_DISP0_DATA19,
	MX6Q_PAD_DISP0_DAT20__IPU1_DISP0_DATA20,
	MX6Q_PAD_DISP0_DAT21__IPU1_DISP0_DATA21,
	MX6Q_PAD_DISP0_DAT22__IPU1_DISP0_DATA22,
	MX6Q_PAD_DISP0_DAT23__IPU1_DISP0_DATA23,
};
...
static iomux_v3_cfg_t const button_pads[] = {
	...
	/* Volume Down */
	IOMUX_PADS(PAD_GPIO_19__GPIO4_IO05 | MUX_PAD_CTRL(BUTTON_PAD_CTRL)),
	/* Volume Up */
...
static iomux_v3_cfg_t const init_pads[] = {
	/* SGTL5000 sys_mclk */
	IOMUX_PADS(PAD_GPIO_0__CCM_CLKO1 | MUX_PAD_CTRL(OUTPUT_40OHM)),
	/* MIPI J16 pin 14 NANDF_D5 */
	IOMUX_PADS(PAD_NANDF_D5__GPIO2_IO05 | MUX_PAD_CTRL(OUTPUT_40OHM)),
	/* MIPI J16 pin 12 MIPI_BAKLGT_ON */
	IOMUX_PADS(PAD_NANDF_WP_B__GPIO6_IO09 | MUX_PAD_CTRL(OUTPUT_40OHM)),
	/* Camera J5 pin 17 MCLK */
	IOMUX_PADS(PAD_GPIO_3__CCM_CLKO2 | MUX_PAD_CTRL(OUTPUT_40OHM)),
	/* Camera J5 pin 26 CSI0_RST */
	IOMUX_PADS(PAD_GPIO_8__GPIO1_IO08 | MUX_PAD_CTRL(OUTPUT_40OHM)),
	/* Camera J5 pin 32 GPIO6 */
	IOMUX_PADS(PAD_GPIO_6__GPIO1_IO06 | MUX_PAD_CTRL(OUTPUT_40OHM)),
};

static unsigned int gpios_out_low[] = {
	IMX_GPIO_NR(3, 22),	/* disable USB otg power */
	IMX_GPIO_NR(2, 5),	/* ov5640 mipi camera reset */
	IMX_GPIO_NR(1, 8),	/* ov5642 reset */
};

static unsigned int gpios_out_high[] = {
	IMX_GPIO_NR(1, 6),	/* ov5642 powerdown */
	IMX_GPIO_NR(6, 9),	/* ov5640 mipi camera power down */
};

static void set_gpios(unsigned int *p, int cnt, int val)
{
	int i;
