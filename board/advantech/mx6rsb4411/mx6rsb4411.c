...
static void __maybe_unused enable_rgb(struct display_info_t const *dev)
{
	SETUP_IOMUX_PADS(rgb_pads);
	enable_backlight();
}

static void __maybe_unused enable_lvds(struct display_info_t const *dev)
{
	enable_backlight();
}
